...
namespace ManiaNet.ConsoleTesting
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            xmlRpcConnection.SendRequest(XmlRpcConstants.XmlDeclaration + XmlRpcConstants.MethodCallAndNameOpening + "GetChatLines" + XmlRpcConstants.MethodNameClosingAndParamsOpening  /* + XmlRpcConstants.ParamOpening + "<value><string>system.methodSignature</string></value>" + XmlRpcConstants.ParamClosing + XmlRpcConstants.ParamOpening + "<value><int>0</int></value>" + XmlRpcConstants.ParamClosing */ + XmlRpcConstants.ParamsAndMethodCallClosing);
