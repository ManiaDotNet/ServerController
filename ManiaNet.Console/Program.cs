...
namespace ManiaNet.ConsoleTesting
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            xmlRpcConnection.SendRequest(XmlRpcConstants.XmlDeclaration + XmlRpcConstants.MethodCallAndNameOpening + "GetCurrentGameInfo" + XmlRpcConstants.MethodNameClosingAndParamsOpening + /* XmlRpcConstants.ParamOpening + "<value><int>2</int></value>" + XmlRpcConstants.ParamClosing + XmlRpcConstants.ParamOpening + "<value><int>2</int></value>" + XmlRpcConstants.ParamClosing + */ XmlRpcConstants.ParamsAndMethodCallClosing);
