...
namespace ManiaNet.ConsoleTesting
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            string request = XmlRpcConstants.MethodCallAndNameOpening + "Echo" + XmlRpcConstants.MethodNameClosingAndParamsOpening + XmlRpcConstants.ParamOpening + "<value><string>Description</string></value>" + XmlRpcConstants.ParamClosing + XmlRpcConstants.ParamOpening + "<value><string>banane9</string></value>" + XmlRpcConstants.ParamClosing + XmlRpcConstants.ParamsAndMethodCallClosing;
